(function () {
    ...
    app.controller('FamiliesController', function ($scope, $modal, $timeout, FamiliesService) {
    ...
    app.controller('FamiliesMenuController', function ($scope, $modal, $state, $timeout, FamiliesService) {
