(function () {
    ...
    app.controller('MakeOrderController', function ($scope, ClientsService, $modal, $state) {
    ...
    app.controller('OrderAddProductController', function ($scope, ProductsService, OrdersService, $state, $stateParams, $filter, config) {
    ...
    app.controller('OrderCategoryController', function ($scope, ProductsService, OrdersService, $stateParams, config) {
        $scope.maxPages = config.maxPages;
        $scope.itemsPerPage = config.itemsPerPage;
    ...
    app.controller('OrderAddProductMenuController', function ($scope, OrdersService, $state, config) {
    ...
    app.controller('OrderResumeController', function ($rootScope, $scope, OrdersService, ProductsService, $state, $filter, config) {
        if (!localStorage.order) {
            $state.go('pedidoCrear');
        } else {
            $scope.order = localStorage.getObject('order');
    ...
    app.controller('OrderDetailController', function ($scope, $stateParams, OrdersService) {
    ...
    app.controller('OrderResumeMenuController', function ($scope, OrdersService, ClientsService, $state, $modal, $q, $timeout) {
    ...
    app.controller('OrderListController', function ($rootScope, $scope, $modal, $timeout, $state, OrdersService, $q, $stateParams, ProductsService, config) {
    ...
    app.controller('InvoiceListController', function ($scope, $modal, $timeout, $stateParams, OrdersService, config) {
    ...
    app.controller('DetailInvoiceController', function ($scope, $stateParams, OrdersService, ConfigService) {
    ...
    app.controller('DetailInvoiceMenuController', function ($scope) {
