(function () {
    ...
    app.controller('ProductsRootFamiliesController', function ($scope, $state, ProductsService, $stateParams, config) {
    ...
    app.controller('ProductsListController', function ($scope, $stateParams, $filter, $state, ProductsService, config) {
    ...
    app.controller('AddProductsController', function ($scope, ProductsService, $location, $q, $upload, $state, $timeout, config) {
    ...
    app.controller('ProductsDetailController', function ($scope, $stateParams, ProductsService, $location, $q, resolveProduct, resolvePrice, resolveProductImage, $window, $timeout, config, $modal, $state) {
