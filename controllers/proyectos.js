(function () {
    ...
    app.controller('ProjectsController', function ($scope, $modal, $timeout, $stateParams, ClientsService, ProjectsService, config) {
    ...
    app.controller('DetailProjectsController', function ($rootScope, $scope, $stateParams, ProjectsService, $modal, $timeout, resolveProject, $state) {
    ...
    app.controller('AddProjectController', function ($scope, ClientsService, ProjectsService, $timeout, $state, $stateParams, $filter) {
    ...
    app.controller('TasksListController', function ($rootScope, $scope, $stateParams, $modal, $state, $timeout, ProjectsService, config) {
    ...
    app.controller('TasksListMenuController', function ($scope,$stateParams) {
        $scope.projectID = $stateParams.projectID;
    });
    app.controller('DetailTaskController', function ($rootScope, $scope, $stateParams, ProjectsService, UsersService, $modal, $timeout, resolveTask, $state, $filter) {
    ...
    app.controller('AddTaskController', function ($rootScope, $scope,$stateParams,ProjectsService,UsersService, $timeout, $state) {
        $scope.projectID = $stateParams.projectID;
        if($stateParams.clientID){
        $scope.clientID = $stateParams.clientID;
