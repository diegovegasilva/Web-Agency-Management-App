(function () {
    ...
    app.controller('ListExpensesController', function ($scope, UsersService, ExpensesService, config, $modal, $timeout, $state) {
    ...
    app.controller('AddExpensesController', function ($scope, UsersService, ExpensesService, $timeout, $state) {
