(function () {
    ...
    app.controller('UsersController', function ($scope, $modal, $timeout, UsersService, config) {
    ...
    app.controller('DetailUsersController', function ($scope, $stateParams, UsersService, $location, $modal, $timeout, resolveUser, $state, config, $q) {
    ...
    app.controller('AddUsersController', function ($scope, UsersService, $location, $q, $timeout, $state, $upload, config) {
    ...
    app.controller('DetailUserController', function ($rootScope, $scope, $stateParams, UsersService, $location, $modal, $timeout, resolveUser, $state, config, $q) {
