(function () {
    ...
    app.controller('ClientsController', function ($scope, $modal, $timeout, ClientsService, config) {
    ...
    app.controller('DetailClientsController', function ($rootScope, $scope, $stateParams, ClientsService, ProjectsService, $modal, $timeout, resolveClient, $state, $filter) {
    ...
    app.controller('DetailClientsMenuController', function ($scope, $stateParams) {
        $scope.clientID = $stateParams.clientID;
    });
    app.controller('AddClientsController', function ($scope, ClientsService, $timeout, $state) {
