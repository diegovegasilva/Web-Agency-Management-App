(function () {
    ...
    app.controller('LoginController', ['$rootScope', '$scope', 'LoginService', '$modalInstance', function ($rootScope, $scope, LoginService, $modalInstance) {
    ...
    app.controller('LoginFormController', ['$scope', '$rootScope', '$window', '$state', '$timeout', 'LoginService',function ($scope, $rootScope, $window, $state, $timeout, LoginService) {
